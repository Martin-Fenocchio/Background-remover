...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#16244F] text-white p-8">
      <img src={Logo} className="logo" />

      <h3>LCD Placas</h3>
      <p className="desc">Borrador de fondos</p>
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-sm text-gray-400">
            o arrastrar y soltar fotos aca
          </p>
        </div>
        {images.length ? (
          <div className="flex flex-col items-center gap-4 mb-8">
            ...
            >
              {isProcessing ? "Borrando fondos..." : "Borrar fondos"}
            </button>
